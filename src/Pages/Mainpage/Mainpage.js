...
<>
        <div className='main-wrapper'>
            ...
            <div className='first-fragment'>
                ...
                <p className='first-fragment-text'>Давайте пройдем онлайн-курс, чтобы улучшить
                    свои навыки по-другому, вы можете
                    установить свое собственное время обучения
                    в соответствии с вашими потребностями в
                    обучении. Так Вы можете спокойно учиться
                    и усваивать материал.</p>
                <div>
